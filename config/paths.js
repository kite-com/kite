...
module.exports = {
  ...
  commonSass: resolveApp('src/common/sass'),
  ...
  appModule: resolveApp('src/modules'),
  ...
  themeConfig: resolveApp('src/util/themeConfig'),
  appStatic: resolveApp('src/static'),
  appImage: resolveApp('src/static/image'),
  appDoc: resolveApp('src/docs'),
  appTest: resolveApp('src/tests'),
  publicUrlOrPath,
};
